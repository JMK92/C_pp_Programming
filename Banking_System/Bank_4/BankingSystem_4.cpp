/*  Account 클래스에 const 예약어를 통해 코드의 안전성을 높인다 */ // -> 변경할 수 없는 부분 만들기
...
public:
	...
	// 복사생성자
	Account(const Account& ref)               // 다른 객체가 들어오면 안됨으로.
	...
	int getBalance() const { return balance; }   // const
	...
	void showAccount() const {                 // const -> const한거는 보여주기만 하는 거라서 const 사용
